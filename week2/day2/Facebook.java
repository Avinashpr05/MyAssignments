...
public class Facebook {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//button[contains(text(),'optional')]"
				+ "")).click();
		...
		// Enter the last name
		driver.findElement(By.xpath("//div[text()='Surname']/following-sibling::input")).sendKeys("W");

		// Enter the mobile number
		driver.findElement(By.xpath("(//div[@class='placeholder']/following-sibling::input)[3]")).sendKeys("0123456789");

		// Enter the password
		driver.findElement(By.xpath("(//div[@class='placeholder']/following-sibling::input)[5]")).sendKeys("asdf1234");
